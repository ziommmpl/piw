...
#ustawiam parametry kamery
cap.set(3,800)  #rozdzielczosc szerokosc
cap.set(4,600)  #rozdzielczosc wysokosc
cap.set(5, 60)  #frame rate
cap.set(10,10)  #brightness
cap.set(15,10)  #ekspozycja
cx_wy=0;
cy_wy=0;
...
while (1):
    ...
    #iterowanie na skrajach
    cv2.rectangle(frame,(0,0),(100,500), [0,255,0])
    if (cx>0 and cx<100 and cy>0 and cy<500):
        cx_wy=cx_wy-20
    cv2.rectangle(frame,(550,0),(650,500), [0,255,0])
    if (cx>550 and cx<650 and cy>0 and cy<500):
        cx_wy=cx_wy+20

    cv2.rectangle(frame,(0,0),(650,100), [0,0,255])
    if (cx>0 and cx<650 and cy>0 and cy<100):
        cy_wy=cy_wy-20
    cv2.rectangle(frame,(0,400),(650,500), [0,0,255])
    if (cx>0 and cx<650 and cy>400 and cy<500):
        cy_wy=cy_wy+20
    ...
    #poruszanie kursorem
    pyautogui.moveTo((cx+cx_wy, cy+cy_wy))
